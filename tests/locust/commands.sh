...
# Rerun1
locust -f .\tests\locust\testing_locust.py --host http://86.50.168.252/ --users 500 --spawn-rate 4 --run-time 110s --csv .\tests\locust\results\api1\rerun1\rerun1 --csv-full-history
locust -f .\tests\locust\testing_locust.py --host http://86.50.168.252/ --users 500 --spawn-rate 4 --run-time 110s --csv .\tests\locust\results\api4\rerun1\rerun1 --csv-full-history
locust -f .\tests\locust\testing_locust.py --host http://86.50.168.252/ --users 500 --spawn-rate 4 --run-time 110s --csv .\tests\locust\results\api7\rerun1\rerun1 --csv-full-history

# Rerun2
locust -f .\tests\locust\testing_locust.py --host http://86.50.168.252/ --users 500 --spawn-rate 4 --run-time 110s --csv .\tests\locust\results\api1\rerun2\rerun2 --csv-full-history
